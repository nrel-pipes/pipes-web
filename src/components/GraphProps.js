...
import { Position, Handle, useUpdateNodeInternals } from "react-flow-renderer";
  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ fontSize: 9 }}>{data.label}</div>
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{ fontSize: "8px", paddingRight: 5 }}
    ...
    <div style={{ fontSize: 10 }}>
      ...
      <svg width={60} height={60} viewBox="0 0 40 40">
        ...
        <circle
          ...
          strokeDashoffset={30}
        />
        <text x="20" y="23" textAnchor="middle" className="complete">
          {Math.round(value)}%
        </text>
      </svg>
    </div>
