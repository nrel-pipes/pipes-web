...
const AssumptionsSectionIFAC = ({ control, register, errors, watch, setValue, storedData }) => {
  ...
  return (
    <div className="form-field-group">
      <Form.Label className="form-field-label">
        <span className="form-field-text">Assumptions and Features</span>
      </Form.Label>
      <Form.Text className="text-muted d-block mb-3">
        Add key assumptions and features for your model
      </Form.Text>
...
export default AssumptionsSectionIFAC;
